			...
			<SafeAreaView className="flex-1 bg-neutral-50">
				...
				<View className="px-6 py-4 bg-white border-b border-neutral-200">
					<View className="flex-row justify-between items-center">
						...
						<Text className="text-lg font-bold text-neutral-900">メンバー追加</Text>
						<View className="w-10" />
					</View>
				</View>
				...
				<ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
					<View className="p-6 gap-6">
						{/* 説明 */}
						<Card variant="gradient" shadow="soft">
						...
						<Card variant="elevated" shadow="soft">
							<View className="gap-4">
								<View className="flex-row items-center gap-3">
									...
									<Text className="text-lg font-semibold text-neutral-900">補足情報</Text>
						...
						<Card variant="elevated" shadow="soft">
							<View className="gap-3">
								<View className="flex-row items-center gap-3">
									...
									<Text className="text-lg font-semibold text-neutral-900">プライバシー</Text>
								</View>
