						...
						<Card variant="elevated" shadow="soft">
							<View className="gap-4">
								<View className="flex-row items-center gap-3">
									...
									<Text className="text-lg font-semibold text-neutral-900">店舗情報</Text>
								</View>
						...
						<Card variant="elevated" shadow="soft">
							<View className="gap-4">
								<View className="flex-row items-center gap-3">
									...
									<Text className="text-lg font-semibold text-neutral-900">総合評価</Text>
									{errors.rating && (
								...
								<View className="items-center gap-3">
									{renderStars()}
									<Text className={`text-base font-medium ${formData.rating > 0 ? 'text-neutral-900' : 'text-neutral-500'
										}`}>
								...
								{errors.rating && (
									<Text className="text-sm text-error-600">{errors.rating}</Text>
								)}
							</View>
						</Card>
						...
						<Card variant="elevated" shadow="soft">
							<View className="gap-4">
								<View className="flex-row items-center gap-3">
									...
									<Text className="text-lg font-semibold text-neutral-900">主観メモ</Text>
								</View>
						...
						<Card variant="elevated" shadow="soft">
							<View className="gap-4">
								<View className="flex-row items-center gap-3">
									...
									<Text className="text-lg font-semibold text-neutral-900">会計情報</Text>
								...
								<View className="flex-row gap-3">
									...
									<Input
										...
										onChangeText={(text) => setFormData(prev => ({ ...prev, costPerPerson: text }))}
										keyboardType="numeric"
										className="flex-1"
						...
						<Card variant="elevated" shadow="soft">
							<View className="gap-4">
								<View className="flex-row items-center gap-3">
									...
									<Text className="text-lg font-semibold text-neutral-900">共有設定</Text>
								</View>
