			...
			<SafeAreaView className="flex-1 bg-neutral-50">
				...
				<View className="px-6 py-4 bg-white border-b border-neutral-200">
					<View className="flex-row justify-between items-center">
						...
						<Text className="text-lg font-bold text-neutral-900">新しいイベント</Text>
						<View className="w-10" />
					</View>
				</View>
						...
						<Card variant="elevated" shadow="soft">
							<View className="gap-4">
								<View className="flex-row items-center gap-3">
									...
									<Text className="text-lg font-semibold text-neutral-900">イベント情報</Text>
								</View>
						...
						<Card variant="elevated" shadow="soft">
							<View className="gap-4">
								<View className="flex-row items-center gap-3">
									...
									<Text className="text-lg font-semibold text-neutral-900">飲み会の目的</Text>
						...
						<Card variant="elevated" shadow="soft">
							<View className="gap-4">
								<View className="flex-row items-center gap-3">
									...
									<Text className="text-lg font-semibold text-neutral-900">開催日時</Text>
								</View>
								...
								<View className="gap-3">
									...
									>
										<View className="flex-row items-center gap-3">
											...
											<Text className={`text-base font-medium ${!formData.hasScheduling ? 'text-primary-700' : 'text-neutral-700'
												}`}>
												日時を設定して始める
											</Text>
										</View>
