...
export const AreaSelectionModal: React.FC<AreaSelectionModalProps> = ({
	...
	const [selectionType, setSelectionType] = useState<'center' | 'specified' | null>(null);
			...
			<SafeAreaView className="flex-1 bg-neutral-50">
				...
				<View className="px-6 py-4 bg-white border-b border-neutral-200">
					<View className="flex-row justify-between items-center">
						...
						<Text className="text-lg font-bold text-neutral-900">エリア選択</Text>
						<View className="w-10" />
					</View>
				</View>
				...
				<ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
					<View className="p-6 gap-6">
										...
										<View className="flex-1">
											<View className="flex-row items-center gap-2">
												...
												<View className="bg-success-100 rounded-full px-2 py-1">
													<Text className="text-xs font-bold text-success-700">推奨</Text>
												</View>
											</View>
						...
						>
							<Card
								variant={selectionType === 'specified' ? 'gradient' : 'elevated'}
								shadow="large"
								animated={true}
							>
								<View className="gap-4">
