...
const mockEvent: Event = {
	...
	members: [
		...
		{ id: '2', userId: '2', name: '佐藤花子', email: 'sato@example.com', responseStatus: 'accepted', dateResponses: [], joinedAt: '2024-01-15' },
